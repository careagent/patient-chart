...
Plans:
- [x] 02-01-PLAN.md — Encryption TypeBox schemas, typed error classes, scrypt+HKDF key derivation
- [x] 02-02-PLAN.md — AES-256-GCM encrypt/decrypt (TDD)
- [x] 02-03-PLAN.md — Ed25519 sign/verify + X25519 key agreement (TDD)
- [x] 02-04-PLAN.md — Key ring (create/load/save/rotate), vault.json KDF extension, package exports, human verification
...
Plans:
- [x] 03-01-PLAN.md — Ledger TypeBox schemas (26 entry types, EntryAuthor, EntryMetadata, SignableContent, LedgerEntry), error classes, canonicalize function
- [x] 03-02-PLAN.md — LedgerWriter (sign -> encrypt -> chain -> append) and LedgerReader (decrypt -> verify signature) with TDD
- [x] 03-03-PLAN.md — IndexManager (O(1) lookups by type/author/id) and query engine (filter by type, author, date, amends) with TDD
- [x] 03-04-PLAN.md — Ledger integrity verification (chain-only and full chain+signature), package exports, human verification
